        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              className="flex-1 bg-[#111] border border-[#333] focus:border-[#0052FF] text-white font-mono text-sm px-4 py-3 rounded-lg outline-none transition-colors placeholder:text-gray-600"
            />
            <button
              onClick={handleGo}
              className="bg-[#0052FF] hover:bg-[#0040CC] text-white font-mono font-bold text-sm px-5 py-3 rounded-lg transition-colors"
            >
              GO →
            </button>
          </div>
              ...
              {POPULAR.map(p => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-mono text-[#0052FF] border border-[#0052FF]/30 px-1.5 py-0.5 rounded">
                      {p.chain}
                    </span>
                  </div>
