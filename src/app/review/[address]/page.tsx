        ...
        <div className="w-full max-w-lg space-y-4">
          ...
          <div className="bg-[#111] border border-[#222] rounded-xl p-5">
            ...
            <div className="grid grid-cols-4 gap-2 mt-4 pt-4 border-t border-[#1a1a1a]">
              ...
              <div className="text-center">
                <div className="text-xs font-mono font-bold text-[#3b82f6]">{pct(bd?.completionRate)}</div>
                <div className="text-[9px] font-mono text-gray-600">Complete</div>
              </div>
              <div className="text-center">
                <div className="text-xs font-mono font-bold text-[#3b82f6]">{pct(bd?.paymentRate)}</div>
