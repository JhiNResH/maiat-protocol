...
// Wrap with x402 payment protection — $1.00 per registration
export const POST = withX402(
  registerPassportHandler,
  createRouteConfig(
    X402_PRICES.registerPassport,
    "Register a Maiat Passport with ENS subname, ERC-8004 identity, and KYA verification code"
  ),
  x402Server
);
