    ...
    <div className="min-h-screen bg-[#0A0A0A] text-[#E5E5E5]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-12 h-12 rounded-lg bg-[#0052FF]/10 border border-[#0052FF]/30 flex items-center justify-center">
        ...
        <div className="space-y-6 text-[#999999]">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Maiat Protocol is built on <span className="text-[#0052FF] font-medium">Base</span> and
        ...
        <div className="mt-8">
          <Link
            href="/explore"
            className="text-sm font-mono text-[#0052FF] hover:underline"
          >
            ← Back to Explorer
          </Link>
        </div>
