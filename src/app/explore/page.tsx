...
const SEED_ITEMS: ExploreItem[] = [
  { id: '1', address: '0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24', name: 'Uniswap V3 Router', category: 'DEX', chain: 'Base', trustScore: 847, riskLevel: 'LOW', txCount: 245891, reviewCount: 47, ageLabel: '4y', starRating: 4.7, latestReview: 'Battle-tested protocol with consistent performance.', iconLetter: 'U', iconColor: '#FF007A' },
  { id: '2', address: '0xA238Dd80C259a72e81d7e4664a9801593F98d1c5', name: 'Aave V3 Pool', category: 'Lending', chain: 'Base', trustScore: 920, riskLevel: 'LOW', txCount: 189432, reviewCount: 38, ageLabel: '3y', starRating: 4.5, latestReview: 'Solid lending protocol, governance is strong.', iconLetter: 'A', iconColor: '#B6509E' },
  { id: '3', address: '0xcF77a3Ba9A5CA399B7c97c74d54e5b1Beb874E43', name: 'Aerodrome Router', category: 'DEX', chain: 'Base', trustScore: 780, riskLevel: 'LOW', txCount: 312847, reviewCount: 29, ageLabel: '2y', starRating: 4.2, latestReview: 'Best DEX on Base, great liquidity.', iconLetter: 'Ae', iconColor: '#0052FF' },
  { id: '4', address: '0x45f1A95A4D3f3836523F5c83673c797f4d4d263B', name: 'Stargate Router', category: 'Bridge', chain: 'Base', trustScore: 790, riskLevel: 'LOW', txCount: 98234, reviewCount: 15, ageLabel: '2y', starRating: 3.8, latestReview: 'Works well for cross-chain, decent fees.', iconLetter: 'S', iconColor: '#6366F1' },
  { id: '5', address: '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', name: 'USDC', category: 'Stablecoin', chain: 'Base', trustScore: 920, riskLevel: 'LOW', txCount: 1567890, reviewCount: 42, ageLabel: '5y', starRating: 4.6, latestReview: 'Gold standard stablecoin, fully backed.', iconLetter: 'U', iconColor: '#2775CA' },
...
const NEEDS_REVIEW = [
  { name: 'Base Bridge', address: '0x4200000000000000000000000000000000000010', score: 870 },
  { name: 'DAI', address: '0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb', score: 890 },
  { name: 'Chainlink Feed', address: '0x71041dddad3595F9CEd3DcCFBe3D1F4b0a16Bb70', score: 910 },
]
...
function scoreBg(score: number) {
  if (score >= 700) return 'bg-green-500/15 border-green-500/30'
  if (score >= 400) return 'bg-yellow-500/15 border-yellow-500/30'
