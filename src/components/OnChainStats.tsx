...
export function OnChainStats() {
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 pb-16">
      <div className="bg-gradient-to-r from-blue-500/5 to-cyan-500/5 border border-blue-500/20 rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-5">
          ...
          {stats.contractAddress && (
            <a
              ...
              className="ml-auto flex items-center gap-1.5 text-xs text-blue-400 hover:text-blue-300 bg-blue-500/10 border border-blue-500/30 px-3 py-1.5 rounded-full"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-[rgba(13,18,37,0.6)] rounded-xl p-4 text-center">
        ...
        <div className="mt-5 flex items-center justify-center gap-2 text-xs text-zinc-600">
          ...
          <span>→</span>
          <span className="bg-cyan-500/20 text-cyan-300 px-2 py-1 rounded">Gemini AI Check</span>
          <span>→</span>
          <span className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded">BSC On-Chain ✓</span>
          <span>→</span>
