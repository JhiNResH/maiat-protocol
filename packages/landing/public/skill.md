...
| Tier   | Score   | Label         | Verdict   |
|--------|---------|---------------|-----------|
| Gold   | ≥ 70    | LOW RISK      | `proceed` |
| Amber  | 40–69   | MEDIUM RISK   | `caution` |
| Red    | 10–39   | HIGH RISK     | `avoid`   |
| Red    | < 10    | CRITICAL RISK | `avoid`   |

Source: `src/lib/thresholds.ts`
